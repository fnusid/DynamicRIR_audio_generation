...
from src.datasets.semhearing_multi_ch_simulator import Multi_Ch_Simulator
...
class CuratedBinauralAugRIRDataset(CuratedBinauralDataset):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Simulate
        self.simulator = Multi_Ch_Simulator(self.hrtf_dir, self.split, self.sr, self.reverb)
