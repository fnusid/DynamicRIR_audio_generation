...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str, default='/scr/BinauralCuratedDataset/ESC-50')

    args = parser.parse_args()

    label_collector = ESC50LabelCollector(args.dataset_dir, 'src/gen/ontology.json')
